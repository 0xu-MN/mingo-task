            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-3">
                <Button 
                  ...
                  style={{ backgroundColor: '#03C75A', color: '#000' }}
                >
                  네이버 로그인
                </Button>
                <Button variant="outline" type="button" className="border-none w-full" style={{ backgroundColor: '#FEE500', color: '#000' }}>카카오 로그인</Button>
                <Button variant="outline" type="button" className="border-none w-full" style={{ backgroundColor: '#444', color: '#fff' }}>구글 로그인</Button>
              </div>

              <div className="relative flex justify-center items-center py-2">
                <div className="absolute inset-x-0 h-[1px] bg-gray-600"></div>
                <div className="relative bg-black text-gray-400 px-3 text-sm z-10">
                  OR CONTINUE WITH
                </div>
              </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel htmlFor="email" className="text-white">이메일</FormLabel>
                    <FormControl>
                      <Input
                        id="email"
                        type="email"
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className="flex items-center">
                      <FormLabel htmlFor="password" className="text-white">비밀번호</FormLabel>
